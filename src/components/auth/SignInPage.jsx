      ...
      <div className="w-full max-w-72 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-[#070707] py-16 px-4">
          <div className="space-y-6">
            ...
            <p className="text-[#B0B0B0] text-sm text-center" style={{fontFamily: 'SF Pro Rounded, ui-rounded, system-ui, sans-serif'}}>Welcome Back, Let's Start Tracking Chips!</p>
            ...
            <div className="text-center">
              <p className="text-white text-sm" style={{fontFamily: 'SF Pro Rounded, ui-rounded, system-ui, sans-serif'}}>
                Haven't Started Tracking?{' '}
                <a href="/sign-up" className="text-[#414141] hover:text-blue-300 font-bold" style={{fontFamily: 'SF Pro Rounded, ui-rounded, system-ui, sans-serif'}}>
                  Sign up
                </a>
              </p>
            </div>
